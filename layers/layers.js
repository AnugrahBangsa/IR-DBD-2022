...
var lyr_adm_prov__1 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'adm_prov_<br />\
    <img src="styles/legend/adm_prov__1_0.png" /> Dibawah IR rata-rata<br />\
    <img src="styles/legend/adm_prov__1_1.png" /> Diatas IR rata-rata<br />'
        });
...
lyr_adm_prov__1.set('fieldLabels', {'OBJECTID': 'hidden field', 'PROVINSI': 'header label - always visible', 'IR DBD': 'header label - always visible', });
